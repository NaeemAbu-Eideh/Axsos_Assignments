...
<html>
    ...
    <body class="overflow-y-hidden">
        <h1 class="text-3xl font-bold mt-10 mb-15 text-center "> New Category </h1>
        ...
        <form:form cssClass="" action= "/categories/new/add-category" method="post" modelAttribute="category">
